	...
	while country_answer == "y":
		...
		while algorithm_answer == "y":
			...
			if (algorithm == "radio"):
				...
				make_map(radios, file_name, number, x, y, country, algorithm, order_choice)
			...
			# random algorithm with 4, 5, 6, or 7 stations
				...
				make_map(random, file_name, number, x, y, country, algorithm, amount_radios)
			...
			# greedy algorithm with random order or ldo order
				...
				make_map(greed, file_name, number, x, y, country, algorithm, order_choice)
				...
				make_map(depth, file_name, number, x, y, country, algorithm, order_choice)
				...
				if success == "yes":
					...
					make_map(hill[0], file_name, number, x, y, country, algorithm, order_choice)
